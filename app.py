...
def upload_timetable():
    ...
    try:
        ...
        sys_prompt += "TIME RULE: If a class block occupies 2 HOURS continuously on the timetable, it MUST be classified as a 'Practical'. If it is 1 HOUR, it MUST be classified as a 'Lecture'.\n"
